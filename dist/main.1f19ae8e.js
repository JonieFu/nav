...
console.log(_delete.default); // let $add = $(".site:last");

var $last = $(".site:last"); // 获取数据函数
...
var saveData = function saveData(hashMap) {
...
var timeOutEvent; // 渲染数据函数;

var render = function render() {
  $last.siblings(".site").remove();
  hashMap.forEach(function (n, index) {
    var $li = $("<li class=\"site\" >\n          <div class=\"del\" id = ".concat(index, ">\n            <img class=\"picDel\" src=\"").concat(_delete.default, "\" />\n          </div>\n          <a href=\"").concat(n.url, "\" target=\"_self\">\n            <div class=\"box\">\n              <div class=\"logo\">").concat(n.logo, "</div>\n              <div class=\"link\">").concat(n.link, "</div>\n            </div>\n          </a>\n        </li>")); // 添加节点
...
render(); // 添加点击事件应该先获取并渲染之前的数据;

$last.on("click", function () {
  var link = window.prompt("添加我的导航：");
...
},{"./img/delete.png":"img/delete.png"}],"../../../../AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
